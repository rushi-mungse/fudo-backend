    ...
    describe("Given all fields", () => {
        it("should returns the 200 status code", async () => {
            ...
            const setPasswordResponse = await request(app)
                ...
                .send({
                    ...forgetPasswordResponse.body.otpInfo,
                    otp: forgetPasswordResponse.body.otp,
                    password: "12345678",
        ...
        it("should return user data", async () => {
            ...
            expect(setPasswordResponse.body).toHaveProperty("user");
        });
        ...
        it("should returns the 408 status code if otp expired", async () => {
            ...
            const setPasswordResponse = await request(app)
                ...
                .send({
                    ...
                    confirmPassword: "12345678",
                    hashOtp: `${
                        forgetPasswordResponse.body.otpInfo.hashOtp.split(
                            "#",
                        )[0]
                    }#${Date.now() - 1000 * 60 * 10}`,
                });
